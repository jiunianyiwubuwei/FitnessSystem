...
SECRET_KEY = "django-insecure-@92f&&8*o8j(bz(5^q@v7#i6e+68b+qns*l9d$xkpt$)88+mq="
...
MIDDLEWARE = [
    "corsheaders.middleware.CorsMiddleware",  # 确保 CORS 头最先添加
